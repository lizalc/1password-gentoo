...
SRC_URI="
	amd64? (
		https://downloads.1password.com/linux/tar/stable/x86_64/${P}.x64.tar.gz
		https://downloads.1password.com/linux/tar/stable/x86_64/${P}.x64.tar.gz.sig
	)
	arm64? (
		https://downloads.1password.com/linux/tar/stable/aarch64/${P}.arm64.tar.gz
		https://downloads.1password.com/linux/tar/stable/aarch64/${P}.arm64.tar.gz.sig
	)
"
S="${WORKDIR}"
